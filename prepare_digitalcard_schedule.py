...
if not files:
    raise SystemExit("No digitalcard_batch_*.json — run generate_digitalcard_batch.py + build_digitalcard_assets.py")
...
IMAGE_TIME = os.environ.get("DIGITALCARD_IMAGE_TIME", "11:00 AM")
CAROUSEL_TIME = os.environ.get("DIGITALCARD_CAROUSEL_TIME", "4:00 PM")
IMAGE_BY_WD = {
    0: "1:00 PM",
    1: "11:00 AM",
    2: "12:00 PM",
...
def find_pdf(day_i, day_date):
    ...
    car_name = f"digitalcard-day-{day_i:02d}"
...
for day in posts_days:
    ...
    img_time = IMAGE_BY_WD[d.weekday()] if not os.environ.get("DIGITALCARD_IMAGE_TIME") else IMAGE_TIME
    car_time = CAROUSEL_BY_WD[d.weekday()] if not os.environ.get("DIGITALCARD_CAROUSEL_TIME") else CAROUSEL_TIME
    ...
    day_posts = [
        ...
        },
        {
            ...
            "caption": car_caption,
            "assetPath": pdf,
            # LinkedIn document titles hard-fail Done above 58 characters
...
payload = {
    ...
    "scheduleNote": (
        ...
        "Niche: digital visiting cards / QR / WhatsApp networking."
    ),
